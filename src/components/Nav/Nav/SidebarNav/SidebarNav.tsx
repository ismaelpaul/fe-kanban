...
const SidebarNav = ({ setIsSidebarNavOpen, boards }: SidebarNavProps) => {
	...
	return (
		<motion.div
			...
			bg-white dark:bg-dark-grey w-[16.5rem] top-20 rounded-lg py-[1.188rem] z-40 tablet:ml-0 tablet:top-0 tablet:py-0 tablet:h-full tablet:border-r tablet:border-lines-light tablet:dark:border-lines-dark tablet:rounded-none`}
		>
